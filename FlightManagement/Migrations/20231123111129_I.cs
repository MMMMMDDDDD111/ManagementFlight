        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdateVersionId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UpdateVersions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UpdateVersions_DocumentInfo_DocID",
                        column: x => x.DocID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreviousVersions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PreviousVersions_DocumentInfo_DocumentInformationId",
                        column: x => x.DocumentInformationId,
                        principalTable: "DocumentInfo",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PreviousVersions_UpdateVersions_UpdateVersionId",
                        column: x => x.UpdateVersionId,
                        principalTable: "UpdateVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PreviousVersions_DocumentInformationId",
                table: "PreviousVersions",
                column: "DocumentInformationId");

            migrationBuilder.CreateIndex(
                name: "IX_PreviousVersions_UpdateVersionId",
                table: "PreviousVersions",
                column: "UpdateVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_UpdateVersions_DocID",
                table: "UpdateVersions",
                column: "DocID");
        }
